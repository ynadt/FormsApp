...
import { fetchTemplates, deleteTemplates } from '../api/templates';
...
import adminTemplateColumns from '../constants/adminTemplatesColumns.ts';
...
const AdminTemplatesPage: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['templates', sorting],
    queryFn: () => fetchTemplates({ sort: getSortParam() }),
    ...
    <DashboardLayout>
      ...
      >
        <CustomPageHeader
          ...
          subtitle="Manage templates of all users"
        />
